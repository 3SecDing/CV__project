...
class LightResiualModel(nn.Module):
    def __init__(self, upsample_type='deconv'):
        super(LightResiualModel, self).__init__()
        in_channels = 4
